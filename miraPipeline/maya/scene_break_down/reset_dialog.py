...
class Ui_reset_dlg(object):
    def setupUi(self, reset_dlg):
        ...
        QObject.connect(self.duration_spin, SIGNAL("valueChanged(QString)"), self.duration_label.setText)
        QObject.connect(self.cancel_btn, SIGNAL("clicked()"), reset_dlg.close)
        QObject.connect(self.ok_btn, SIGNAL("clicked()"), reset_dlg.close)
        QMetaObject.connectSlotsByName(reset_dlg)

    def retranslateUi(self, reset_dlg):
        try:
            reset_dlg.setWindowTitle(QApplication.translate("reset_dlg", "设置版本更新时间间隔", None, QApplication.UnicodeUTF8))
            self.info_label_1.setText(QApplication.translate("reset_dlg", "设置版本更新间隔时间为", None, QApplication.UnicodeUTF8))
            ...
            reset_dlg.setWindowTitle(QApplication.translate("reset_dlg", "设置版本更新时间间隔", None))
            self.info_label_1.setText(QApplication.translate("reset_dlg", "设置版本更新间隔时间为", None))
