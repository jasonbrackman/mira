...
class Ui_scriptEditor(object):
    ...
    def retranslateUi(self, scriptEditor):
        scriptEditor.setWindowTitle(QApplication.translate("scriptEditor", "MainWindow", None, QApplication.UnicodeUTF8))
        self.file_menu.setTitle(QApplication.translate("scriptEditor", "File", None, QApplication.UnicodeUTF8))
        self.help_menu.setTitle(QApplication.translate("scriptEditor", "Help", None, QApplication.UnicodeUTF8))
        self.tools_menu.setTitle(QApplication.translate("scriptEditor", "Edit", None, QApplication.UnicodeUTF8))
        self.options_menu.setTitle(QApplication.translate("scriptEditor", "Options", None, QApplication.UnicodeUTF8))
        self.theme_menu.setTitle(QApplication.translate("scriptEditor", "Theme", None, QApplication.UnicodeUTF8))
        self.run_menu.setTitle(QApplication.translate("scriptEditor", "Run", None, QApplication.UnicodeUTF8))
        self.toolBar.setWindowTitle(QApplication.translate("scriptEditor", "toolBar", None, QApplication.UnicodeUTF8))
        self.clearHistory_act.setText(QApplication.translate("scriptEditor", "Clear Output", None, QApplication.UnicodeUTF8))
        self.save_act.setText(QApplication.translate("scriptEditor", "Save Script", None, QApplication.UnicodeUTF8))
        self.load_act.setText(QApplication.translate("scriptEditor", "Load Script", None, QApplication.UnicodeUTF8))
        self.exit_act.setText(QApplication.translate("scriptEditor", "Exit", None, QApplication.UnicodeUTF8))
        self.openManual_act.setText(QApplication.translate("scriptEditor", "Manual", None, QApplication.UnicodeUTF8))
        self.quickHelp_act.setText(QApplication.translate("scriptEditor", "Quick Help", None, QApplication.UnicodeUTF8))
        self.saveSeccion_act.setText(QApplication.translate("scriptEditor", "Save session", None, QApplication.UnicodeUTF8))
        self.tabToSpaces_act.setText(QApplication.translate("scriptEditor", "Tab to spaces", None, QApplication.UnicodeUTF8))
        self.spacesToTabs_act.setText(QApplication.translate("scriptEditor", "Spaces to tab", None, QApplication.UnicodeUTF8))
        self.settingsFile_act.setText(QApplication.translate("scriptEditor", "Open Settings Folder", None, QApplication.UnicodeUTF8))
        self.editTheme_act.setText(QApplication.translate("scriptEditor", "Edit ...", None, QApplication.UnicodeUTF8))
        self.shortcuts_act.setText(QApplication.translate("scriptEditor", "Show Shortcuts", None, QApplication.UnicodeUTF8))
        self.donate_act.setText(QApplication.translate("scriptEditor", "Donate", None, QApplication.UnicodeUTF8))
        self.about_act.setText(QApplication.translate("scriptEditor", "About", None, QApplication.UnicodeUTF8))
        self.execAll_act.setText(QApplication.translate("scriptEditor", "Execute All", None, QApplication.UnicodeUTF8))
        self.execSel_act.setText(QApplication.translate("scriptEditor", "Execute Selected", None, QApplication.UnicodeUTF8))
        self.copy_act.setText(QApplication.translate("scriptEditor", "Copy", None, QApplication.UnicodeUTF8))
        self.cut_act.setText(QApplication.translate("scriptEditor", "Cut", None, QApplication.UnicodeUTF8))
        self.paste_act.setText(QApplication.translate("scriptEditor", "Paste", None, QApplication.UnicodeUTF8))
        self.find_act.setText(QApplication.translate("scriptEditor", "Find and Replace", None, QApplication.UnicodeUTF8))
        self.undo_act.setText(QApplication.translate("scriptEditor", "Undo", None, QApplication.UnicodeUTF8))
        self.redo_act.setText(QApplication.translate("scriptEditor", "Redo", None, QApplication.UnicodeUTF8))
        self.printHelp_act.setText(QApplication.translate("scriptEditor", "Print Help", None, QApplication.UnicodeUTF8))
        self.comment_cat.setText(QApplication.translate("scriptEditor", "Comment", None, QApplication.UnicodeUTF8))
