...
class Ui_themeEditor(object):
    ...
    def retranslateUi(self, themeEditor):
        themeEditor.setWindowTitle(QApplication.translate("themeEditor", "Code Theme Editor", None, QApplication.UnicodeUTF8))
        self.label.setText(QApplication.translate("themeEditor", "Completer text size", None, QApplication.UnicodeUTF8))
        self.save_btn.setText(QApplication.translate("themeEditor", "Save", None, QApplication.UnicodeUTF8))
        self.del_btn.setText(QApplication.translate("themeEditor", "Del", None, QApplication.UnicodeUTF8))
        self.apply_btn.setText(QApplication.translate("themeEditor", "Save", None, QApplication.UnicodeUTF8))
