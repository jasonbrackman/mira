...
class FileWidget(QtGui.QWidget):
    def __init__(self, parent=None):
        ...
        self.abort_action = QtGui.QAction('Kill', self)
...
class MainWidget(QtGui.QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setWindowIcon(QtGui.QIcon(os.path.join(path, 'batch_render.ico')))
        ...
        central_widget.setFrameStyle(QtGui.QFrame.Panel | QtGui.QFrame.Raised)
        ...
        top_splitter = QtGui.QSplitter(QtCore.Qt.Horizontal, main_splitter)
        top_splitter.insertWidget(0, self.file_list_widget)
        
        right_splitter = QtGui.QSplitter(QtCore.Qt.Vertical, top_splitter)
