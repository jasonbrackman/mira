...
class Ui_reset_dlg(object):
    ...
    def retranslateUi(self, reset_dlg):
        reset_dlg.setWindowTitle(QtGui.QApplication.translate("reset_dlg", "设置版本更新时间间隔", None, QtGui.QApplication.UnicodeUTF8))
        self.info_label_1.setText(QtGui.QApplication.translate("reset_dlg", "设置版本更新间隔时间为", None, QtGui.QApplication.UnicodeUTF8))
