...
def get_asset_list(src_context, dst_context):
    ...
    for ref_file in project_ref_files:
        ...
        dst_path = pipeFile.get_asset_step_publish_file(asset_type, asset_name, dst_context, project)
